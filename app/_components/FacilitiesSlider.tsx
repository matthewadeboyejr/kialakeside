...
const facilities = [
  {
    ...
    imageUrl: "/new-conducive-learning-environment.jpg",
    icon: (
  ...
  },
  {
    ...
    imageUrl: "/new-computer-room.jpg",
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  },
  {
    ...
    imageUrl: "/new-home-economics.jpg",
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  },
  {
    ...
    imageUrl: "/new-sporting-facilities.jpg",
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  },
  {
    ...
    imageUrl: "/new-conference-room.jpg",
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  },
  {
    ...
    imageUrl: "/new-well-equipped-auditorium.jpg",
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
